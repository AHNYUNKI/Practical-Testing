...
import sampl.cafekiosk.spring.ControllerTestSupport;
...
class ProductControllerTest extends ControllerTestSupport {
    ...
    public void createProductWithType() throws Exception {
        // given
        ProductResponse request = ProductResponse.builder()
                .sellingStatus(ProductSellingStatus.SELLING)
                .name("아메리카노")
    ...
    public void createProductWithName() throws Exception {
        // given
        ProductResponse request = ProductResponse.builder()
                .type(ProductType.HANDMADE)
                .sellingStatus(ProductSellingStatus.SELLING)
    ...
    @Test
    @DisplayName("신규 상품을 등록할 때 상품 금액는 양수이다.")
